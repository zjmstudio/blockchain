    ...
    return (
        <div className='featured'>
            <div className='container'>
                ...
                {/*Left Side */}
                <div className='left'>
                    <h2 className='featured-text-h2'>Explore Bitcoin and top crypto like Ethereum and Dogecoin</h2>
                    <p className='featured-text'>See all available assets: Cryptocurrencies and NFT's</p>
